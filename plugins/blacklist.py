...
@Client.on_message(filters.command("block") & filters.user(int(var.OWNER_ID)))
...
@Client.on_message(filters.command("unblock") & filters.user(int(var.OWNER_ID)))
...
@Client.on_message(filters.command("listblock") & filters.user(int(var.OWNER_ID)))
